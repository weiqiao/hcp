...
from RP.ddpg import DDPG
from RP.peg_insertion_env import PegInsertionEnv
from RP.reacher_env import ReacherEnv
...
def main():
    ...
    parser.add_argument('--robot_dir', type=str,
                        default='../xml/gen_xmls/simrobot/peg_insertion')
